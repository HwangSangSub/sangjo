...
<div class="container-fluid py-5">
    <div class="container py-5">
                        ...
                        <tr>
                            <th scope="row">
                                <div class="d-flex align-items-center">
                                    <img src="img/${item.productImg}" class="img-fluid me-5 rounded-circle" style="width: 80px; height: 80px;" alt="">
                                </div>
                            </th>
                            <td>
                            ...
                            <td>
                                <button  onclick='remove_proNo(event)'  data-cart-no="${item.cartNo}" class="btn btn-md rounded-circle bg-light border mt-4" data-product-id="${item.productNo}">
                                    <i class="fa fa-times text-danger" data-cart-no="${item.cartNo}" ></i>
                                </button>
                            </td>
                        </tr>
                    </c:forEach>
        ...
        <div class="mt-5">
            <input type="text" class="border-0 border-bottom rounded me-5 py-3 mb-4" placeholder="쿠폰 코드">
            <button class="btn border-secondary rounded-pill px-4 py-3 text-primary" type="button">쿠폰 적용</button>
        </div>
